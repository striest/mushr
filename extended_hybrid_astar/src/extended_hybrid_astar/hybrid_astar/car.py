...
MAX_STEER = 0.8#.4#.28#0.29  # [rad] maximum steering angle

# WB = 80  # rear to front wheel
# W = 80  # width of car
# LF =90  # distance from rear to vehicle front end
# LB = 10  # distance from rear to vehicle back end
# MAX_STEER = .4#.28#0.29  # [rad] maximum steering angle

# WB = 60.  # rear to front wheel
# W = 40.  # width of car
# LF = 66.  # distance from rear to vehicle front end
# LB = 20.0  # distance from rear to vehicle back end
...
def rectangle_check(x, y, yaw, ox, oy):
    ...
    for iox, ioy in zip(ox, oy):
        ...
        converted_xy = np.matmul(np.stack([tx, ty]).T,rot)
...
def plot_car(x, y, yaw):
    ...
    for rx, ry in zip(VRX, VRY):
        ...
        converted_xy = np.matmul(np.stack([rx, ry]).T,rot)
